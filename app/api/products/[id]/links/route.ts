...
import { updateAffiliateLinksSchema } from '@/lib/validation/product'
...
export async function PUT(req: NextRequest, { params }: RouteParams) {
  try {
    ...
    const validatedData = updateAffiliateLinksSchema.parse(body)

    await productRepo.updateLinks(params.id, validatedData.links)
